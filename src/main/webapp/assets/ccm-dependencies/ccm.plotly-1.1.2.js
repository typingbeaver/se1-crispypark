...
( function () {
  ...
  const component = {
    ...
    // helper: [ "ccm.load", "https://kaul.inf.h-brs.de/ccmjs/akless-components/modules/versions/helper-6.0.0.min.mjs" ],
    ...
    config: {
      ...
      plotly_lib: [ 'ccm.load', 'assets/ccm-dependencies/plotly-latest.min.js'  ],
